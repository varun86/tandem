...
2. Navigate to `agent-templates/packs/micro-drama-script-studio-pack/`
3. Confirm selection
...
| Issue                  | Solution                                                  |
| ---------------------- | --------------------------------------------------------- |
| Can't find pack folder | Ensure you're in the `agent-templates/packs/` directory   |
...
```
agent-templates/packs/micro-drama-script-studio-pack/outputs/
```
